...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div style="font-size: 30px" class="card-header">{{ __('重設密碼') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div style="font-size: 30px" class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('信箱') }}</label>

                            <div class="col-md-6">
                                <input style="font-size: 20px" id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button style="font-size: 20px; margin-top: 10px" type="submit" class="btn btn-primary">
                                    {{ __('重設密碼') }}
                                </button>
                            </div>
                        </div>
