...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div style="font-size: 30px" class="card-header">{{ __('登入') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}" style="font-size: 30px">
                        @csrf
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 offset-md-4">
                                <div class="form-check">
                                    <input style="width:30px; heigth:30px" type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }}>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <button style="font-size: 20px" type="submit" class="btn btn-primary">
                                    {{ __('登入') }}
                                </button>
