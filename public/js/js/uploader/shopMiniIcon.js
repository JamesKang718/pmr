...
var reSizeableImage = function (image_target) {
    ...
    init = function () {
      ...
      resizeImage(150, 150 * $container[0].clientHeight / $container[0].clientWidth);
      // resizeImage(650, 650 * $container[0].clientHeight / $container[0].clientWidth);
    };
    ...
    pic.onload = function() {
        ...
        $.ajax({
            ...
            error: function(result) {
                ...
                $("#mailInfo").addClass("alert-warning").show().html(result);
                setTimeout(function() {
                    window.location = '/';
                }, 2000);
            }
